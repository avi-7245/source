<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="testdesign.aspx.cs" Inherits="GGC.UI.Cons.testdesign" %>
...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="../../Styles/bootstrap-5.0.2-dist/css/bootstrap.css" />
</head>
<body>
    <div class="container-fluid">
    <div class="row">   
        <div class="col-xs-2 wrap-content-header col-xs-offset-1">
            <div class="wrap-logo">
        ...
        Maharashtra State Electricity Transmission LTD.
            ...
            <%--<div class="col-sm-6 col-md-6 col-xs-6">
                    ...
                    <div class="col-sm-6 col-md-4 col-xs-12 image-container"><img src="../../assets/images/logo.jpg" height="100" class="rounded float-start" /></div>
                    
                    <div class="col-sm-6 col-md-8 col-xs-12" >Maharashtra State Electricity Transmission LTD.</div>
                </div>
            </div>--%>
            <div id="menubar">
                <ul id="menu">
...
--%>
            <div class="mainbody">
                ...
                <td colspan="2">
                <asp:Button 
                            ID="btnSubmit" runat="server" CssClass="button" 
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlNatureOfApp" runat="server" AutoPostBack="True">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ForeColor="Red"
                                ErrorMessage="Select Nature Of Application!" Display="Dynamic" InitialValue="-1" ControlToValidate="ddlNatureOfApp"
                        ...
                        <td>
                            <asp:DropDownList ID="ddlProjectType" runat="server" AutoPostBack="True" 
                                >
                               <%-- <asp:ListItem Value="-1">--Select--</asp:ListItem>
                                <asp:ListItem Value="1">Solar Park</asp:ListItem>
                                <asp:ListItem Value="2">Solar Project</asp:ListItem>
                                <asp:ListItem Value="3">Wind Park</asp:ListItem>
                                <asp:ListItem Value="4">Wind Project</asp:ListItem>
                                <asp:ListItem Value="5">Bagasse</asp:ListItem>
                                <asp:ListItem Value="6">Biomass</asp:ListItem>
                                <asp:ListItem Value="7">Small Hydro</asp:ListItem>
                                <asp:ListItem Value="8">Solid Waste</asp:ListItem>
                                <asp:ListItem Value="9">Industrial Waste</asp:ListItem>--%>
                            </asp:DropDownList>
              ...
              <%--      <tr runat="server" id="trMEDA" visible="false">
                    ...
                    <tr runat="server" id="trStatusOfApp" visible="false">
                        ...
                        <td colspan="3" align="left">
                            <asp:RadioButtonList ID="rbStatusApplicant" runat="server" RepeatDirection="Horizontal" Width="100px">
                    ...
                    <tr runat="server" id="trConsTypeOfLoad" visible="false">
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ForeColor="Red"
                                Display="Dynamic" ErrorMessage="*Required" ControlToValidate="txtConsQuantumPowerDrawn" ValidationGroup="Submit"
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <font color="red">*</font>Name of Applicant/Developer:
                        </td>
                        <td colspan="3">
                            <asp:TextBox ID="txtNameOfPromoter" runat="server" class="form-control" MaxLength="30"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ForeColor="Red"
                                Display="Dynamic" ErrorMessage="*Required" ControlToValidate="txtNameOfPromoter" ValidationGroup="Submit"
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <font color="red">*</font>Project Capacity :
                        </td>
                        <td>
                    ...
                    Display="Dynamic" ForeColor="Red" ErrorMessage="InValid Capacity" ValidationExpression="((\d+)((\.\d{1,2})?))$" ValidationGroup="Submit"></asp:RegularExpressionValidator> 
                        ...
                        <td>
                            ...
                            <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtSchCommDt"
                                PopupButtonID="ibtSchCommDT" Format="yyyy-MM-dd" PopupPosition="Right">
         ...
         <asp:ListItem Value="-1">--Select--</asp:ListItem>
                    ...
                    <tr runat="server" id="trCoOrdinates">
                        ...
                        <td>
                            <asp:TextBox ID="txtLatitude" runat="server" class="form-control" 
                        ...
                        <td>
                            <asp:TextBox ID="txtLongitude" runat="server" class="form-control" 
                                MaxLength="15"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td colspan="3" align="left">
                            <asp:RadioButtonList ID="RbCaptivePower" runat="server" 
                    ...
                    <tr runat="server" id="trConsLoadDemand" visible="false">
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ForeColor="Red"
                                Display="Dynamic" ErrorMessage="*Required" ControlToValidate="txtDrawalVoltLevel" ValidationGroup="Submit"
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                    ...
                    Display="Dynamic" ForeColor="Red" ErrorMessage="InValid Capacity" ValidationExpression="((\d+)((\.\d{1,2})?))$" ValidationGroup="Submit"></asp:RegularExpressionValidator> 
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ForeColor="Red"
                                Display="Dynamic" ErrorMessage="*Required" ControlToValidate="txtReactivePower" ValidationGroup="Submit"
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
