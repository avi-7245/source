<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppHome.aspx.cs" Inherits="GGC.UI.Cons.AppHome" %>
...
<head runat="server">
     ...
     <script type="text/javascript">
        ...
        function openPopup() {
            var url = 'NewGCTerms.aspx';  // URL of the page you want to open in the pop-up window
            var windowName = 'popupWindow'; // Name of the new window
            var windowSize = 'width=800,height=600'; // Size of the window
    ...
    <div id="main">
        ...
        <form id="form1" runat="server">
            <div class="mainbody">
                ...
                <div>
                    <asp:LinkButton ID="lnkCons" runat="server" CssClass="Linkbutton" OnClientClick="openPopup(); return false;" OnClick="lnkCons_Click" >Create New Application</asp:LinkButton>
                </div>
                <br />
                <div class="rounded-corners">
                    <asp:GridView ID="GVApplications" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        OnRowDataBound="GVApplications_RowDataBound" OnSelectedIndexChanged="GVApplications_SelectedIndexChanged">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Edit Form">
                                <ItemTemplate>
                                    <%--<asp:Button ID="btnSelect" Text="Edit" runat="server" ToolTip="Edit" CssClass="button" CommandName="Select"
                                    ...
                                    <asp:ImageButton ID="btnSelect" ImageUrl="~/assets/images/editsquare.png" BorderWidth="0px"
                                        ...
                                        Width="40px" Height="25px" Enabled="false" />
                                     <input type="hidden" name="appid" value='<%# Eval("APPLICATION_NO") %>' />
 <input type="hidden" name="PAN" value='<%# Eval("PAN_TAN_NO") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    ...
                                    <center>
                                        <asp:ImageButton ID="btnDownload" Text="Application Form" ToolTip="Download Application Form"
                                            ImageUrl="~/assets/images/download.png" BorderWidth="0px" Width="30px" Height="30px" Enabled="false"
                            ...
                            <asp:TemplateField HeaderText="Upload Application Form">
                                <ItemTemplate>
                                    <%--<asp:Button ID="btnUploadForm" Text="Upload Form" CssClass="button" runat="server"
                                            CommandName="UploadForm" CommandArgument="<%# Container.DataItemIndex %>" />--%>
                                    <center>
                            ...
                            <asp:TemplateField HeaderText="Pay Committment Fees">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Committment Fees Receipt">
                                <ItemTemplate>
                                    <%--<asp:Button ID="btnRecDownload" Text="Receipt" CssClass="button" runat="server" CommandName="ReceiptDownload"
                                            CommandArgument="<%# Container.DataItemIndex %>" />--%>
                                    <center>
                            ...
                            <asp:TemplateField HeaderText="View FGC">
                                <ItemTemplate>
                                    <%--<asp:Button ID="btnCommFees" Text="Committment Fees" CssClass="button" runat="server"
                                            CommandName="CommittmentFees" CommandArgument="<%# Container.DataItemIndex %>" />--%>
                                    <center>
                                        <asp:ImageButton ID="btnViewFGC" Text="View FGC" ToolTip="View FGC"
                                            ImageUrl="~/assets/images/view.png" BorderWidth="0px" Width="30px" Height="25px" Enabled="true"
                                            runat="server" CommandName="ViewFGC" CommandArgument="<%# Container.DataItemIndex %>" />
                                    </center>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
