<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewDoc.aspx.cs" Inherits="GGC.UI.Cons.ViewDoc" %>
...
<body>
    ...
    <tr>
    <td>
        <asp:Button ID="btnSLD" runat="server" Text="View SLD" CssClass="button" 
            onclick="btnSLD_Click"/>
    </td>
    <td>
