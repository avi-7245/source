...
namespace GGC.UI.Cons
{
    ...
    {
        protected static readonly ILog log = LogManager.GetLogger(typeof(PaymentReceipt));
                        ...
                        try
                        {
                            ...
                            switch (mySqlConnection.State)
                            {
                                ...
                                case System.Data.ConnectionState.Open:
                                    ...
                                    cmd.ExecuteNonQuery();
                                    strQuery = "update APPLICANTDETAILS set WF_STATUS_CD_C=5,IsPaymentDone='Y', paymentdate=CURDATE(), APP_STATUS_DT=CURDATE() ,app_status='REGISTRATION PAYMENT DONE.PAYMENT APPROVAL PENDING.' ,  CustomerID='" + strParams[1] + "' where Application_No='" + strParams[17] + "'";
                                    ...
                                    //strQuery = "select distinct b.email Email from APPLICANTDETAILS a, zone_district b where lower(a.PROJECT_DISTRICT)=lower(b.district) and lower(b.DISTRICT)=(select distinct district from APPLICANTDETAILS where application_no='" + strParams[17] + "')";
                                    //cmd = new MySqlCommand(strQuery, mySqlConnection);
                                    ...
                                    strQuery = "select distinct a.*  from APPLICANTDETAILS a where a.application_no='" + strParams[17] + "'";
                                    ...
                                    DataSet dsResultFinance = SQLHelper.ExecuteDataset(ConfigurationManager.AppSettings["DevpGridConnectivity"].ToString(), CommandType.Text, "select * from empmaster where role_id=31");
            ...
            try
            {
                ...
                switch (mySqlConnection.State)
                {
                    ...
                    case System.Data.ConnectionState.Open:
                        ...
                        objGetStatusDTO.PAYMENT_TYPE = "Registration";
