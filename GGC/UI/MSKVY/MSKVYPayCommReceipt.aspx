<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MSKVYPayCommReceipt.aspx.cs" Inherits="GGC.UI.MSKVY.MSKVYPayCommReceipt" %>
...
<body>
    ...
    <div class="mainbody">
        <center>
            <h3>
               MSKVY Committment Payment Receipt detail.</h3>
        </center>
        <br />
        <br />
        <center>
        ...
        <div>
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/UI/MSKVY/AppHome.aspx">Home</asp:HyperLink>
        </div>
    </div>
    </form>
</body>
