...
{
    public partial class MSKVYPayCommReceipt : System.Web.UI.Page
    {
                        ...
                        try
                        {
                            ...
                            switch (mySqlConnection.State)
                            {
                                ...
                                case System.Data.ConnectionState.Open:
                                    ...
                                    cmd.ExecuteNonQuery();
                                    strQuery = "update MSKVY_applicantdetails  set WF_STATUS_CD_C=16,IsPaymentDone='Y', paymentdate=CURDATE(), APP_STATUS_DT=CURDATE() ,app_status='COMMITTMENT FEES PAID.PAYMENT APPROVAL PENDING.' ,  CustomerID='" + strParams[1] + "' where Application_No='" + strParams[17] + "'";
                                    ...
                                    strQuery = "insert into APPLICANT_STATUS_TRACKING " +
                                            " values('" + strParams[17] + "','MSKVYCommittment PAYMENT DONE',now(),'" + strParams[17] + "')";
                                    cmd = new MySqlCommand(strQuery, mySqlConnection);
                                    cmd.ExecuteNonQuery();
                                    #endregion
                                    ...
                                    if (dsAppDet.Tables[0].Rows.Count > 0)
                                    {
                                        ...
                                        strBody += "Following developer applied and  paid MSKVY Committment Fees for Grid Connectivity Application." + "<br/>";
            ...
            try
            {
                ...
                switch (mySqlConnection.State)
                {
                    ...
                    case System.Data.ConnectionState.Open:
                        ...
                        objGetStatusDTO.PAYMENT_TYPE = "MSKVYCommittment";
