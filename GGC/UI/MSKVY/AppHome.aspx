<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppHome.aspx.cs" Inherits="GGC.UI.MSKVY.AppHome" %>
    ...
    <div id="main">
        ...
        <form id="form1" runat="server">
            <div class="mainbody">
                ...
                <div>
                    <asp:LinkButton ID="lnkCons" runat="server" CssClass="Linkbutton" OnClick="lnkCons_Click">Create New Application</asp:LinkButton>
                </div>
                <br />
                <div class="rounded-corners">
                    <asp:GridView ID="GVApplications" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="POINT_OF_INJECTION" HeaderText="SUBSTATION NAME" />
                            ...
                            <asp:TemplateField HeaderText="Download Deemed GC">
                                <ItemTemplate>
                                    <%--<asp:Button ID="btnRecDownload" Text="Receipt" CssClass="button" runat="server" CommandName="ReceiptDownload"
                                            CommandArgument="<%# Container.DataItemIndex %>" />--%>
                                    <center>
                            ...
                            <asp:BoundField DataField="isAppApproved" HeaderText="isAppApproved" Visible="false" />
