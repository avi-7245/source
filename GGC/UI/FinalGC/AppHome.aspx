<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppHome.aspx.cs" Inherits="GGC.UI.FinalGC.AppHome" %>
    ...
    <div id="main">
        <div id="header">
            <div id="logo">
                <div id="logo_text">
                    ...
                    <img src="../../assets/images/logo.jpg" height="100" align="middle" alt="" />
                    <span class="logo_colour"><span style="font-size: 2em;">Maharashtra State Electricity Transmission Company LTD.</span></span>
                </div>
            </div>
            <div id="menubar">
                <ul id="menu">
        ...
        <form id="form1" runat="server">
            <div class="mainbody">
                ...
                <center>
                    <h3>MSKVY Final GC Application List</h3>
                </center>
                ...
                <div class="rounded-corners">
                    <asp:GridView ID="GVApplications" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="PROJECT_LOC" HeaderText="Location" />
                                ...
                                <ItemTemplate>
                                    ...
                                    <center>
                                        <asp:ImageButton ID="btnDownload" Text="Application Form" ToolTip="Download Application Form"
                                            ...
                                            runat="server" CommandName="DownloadApplicationForm" CommandArgument="<%# Container.DataItemIndex %>" />
                                    </center>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Download Final GC">
                                <ItemTemplate>
                                    ...
                                    <center>
                                        <asp:ImageButton ID="btnDownloadGC" Text="Download" ToolTip="Download"
                                            ImageUrl="~/assets/images/download.png" BorderWidth="0px" Width="30px" Height="30px" Enabled="true"
                                            runat="server" CommandName="DownloadFinalGC" CommandArgument="<%# Container.DataItemIndex %>" />
                                    </center>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Apply to GC">
                                <ItemTemplate>
                                    <%--<asp:Button ID="btnRecDownload" Text="Receipt" CssClass="button" runat="server" CommandName="ReceiptDownload"
                                            CommandArgument="<%# Container.DataItemIndex %>" />--%>
                                    <center>
                                        <asp:ImageButton ID="btnApply" Text="Apply" ToolTip="apply"
                                            ImageUrl="~/assets/images/receipt.jpg" BorderWidth="0px" Width="30px" Height="30px" Enabled="false"
                                            runat="server" CommandName="Apply" CommandArgument="<%# Container.DataItemIndex %>" />
                                    </center>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
