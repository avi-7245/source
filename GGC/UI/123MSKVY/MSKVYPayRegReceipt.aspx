<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MSKVYPayRegReceipt.aspx.cs" Inherits="GGC.UI.MSKVY.MSKVYPayRegReceipt" %>
...
<div style="background-color: #5D7B9D">
    ...
    <div class="mainbody">
        <center>
            <h3>
               MSKVY Registration Payment Receipt detail.</h3>
        </center>
        <br />
        <br />
        <center>
        <table width="50%" cellspacing="5" align="center">
                ...
                <td colspan="2" align="center">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/UI/MSKVY/AppHome.aspx">Click here for Home</asp:HyperLink>
                </td>
                </tr>
            </table>
            </center>
