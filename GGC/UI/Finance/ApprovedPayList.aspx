<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovedPayList.aspx.cs" Inherits="GGC.UI.Finance.ApprovedPayList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Approved Payment List</title>
    <style type="text/css">
        .form-control
        {
            display: block;
...
<div id="main">
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <li class="selected"><a href="ApprovePayment.aspx">Home</a></li>
    ...
    <tr>
    <td>
        <asp:Button ID="btnDownload" runat="server" Text="Export to Excel" 
            ...
            <td>
                <asp:GridView ID="GVPayments" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TxnAmount" HeaderText="Amount" >
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"/>
                        </asp:BoundField>
                        <asp:BoundField DataField="TxnDate" HeaderText="Date"/>
                        <asp:BoundField DataField="TxnNo" HeaderText="Transaction No" />
                        
                        <asp:BoundField DataField="approvedDt" HeaderText="Approve Date" >
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        </asp:BoundField>
                        <asp:BoundField DataField="PaymentApproveByFin" HeaderText="Approved By(SAP ID)" />
