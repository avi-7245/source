<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovePayment.aspx.cs" Inherits="GGC.UI.Finance.ApprovePayment" %>
        ...
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <li class="selected"><a href="MSSPDPayApr.aspx">MSKVY-SPD</a></li>
                    <li class="selected"><a href="MSKVYApprovePay.aspx">MSKVY</a></li>
                    <li class="selected"><a href="VendorRegister.aspx">Home</a></li>

                    <li class="selected"><a href="ApprovedPayList.aspx">Payment Approved List</a></li>
                    <li class="selected"><a href="UpdatePayment.aspx">Update Payment</a></li>
                        ...
                        <td>
                            <asp:GridView ID="GVPayments" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="TxnAmount" HeaderText="Transaction Amount" DataFormatString="{0:C2}">
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="typeofpay" HeaderText="Payment Type">
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="Approve">

                                        <ItemTemplate>
                                            <asp:Button ID="btnAppr" Text="Approve" runat="server" CssClass="button" CommandName="Approve" CommandArgument="<%# Container.DataItemIndex %>" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Return">
                                        <ItemTemplate>
                                            <asp:Button ID="btnDecline" Text="Decline" runat="server" CssClass="button" CommandName="Decline" CommandArgument="<%# Container.DataItemIndex %>" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
