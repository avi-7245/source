<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorRegister.aspx.cs"
    Inherits="GGC.UI.Finance.VendorRegister" %>
        ...
        <div class="mainbody">
            ...
            <table width="100%" align="center" cellspacing="0">
                <tr>
                    ...
                    <Columns>
                        <asp:BoundField DataField="PAN_TAN_NO" HeaderText="PAN"  >
                       ...
                       <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Button ID="btnSelect" Text="View" runat="server" CssClass="button"  CommandName="Select" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>
