<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowGSTIN.aspx.cs" Inherits="GGC.UI.Finance.ShowGSTIN" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>GSTIN Certificate</title>
...
<div class="mainbody">
            <center>
                <h3>
                    <asp:Label ID="lblAppNo" runat="server" Text="GSTIN Certificate for User : "></asp:Label></h3>
            </center>    
             <div>
