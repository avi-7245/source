<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FGCUpDraft.aspx.cs" Inherits="GGC.UI.Emp.FGCUpDraft" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Upload FGC Draft</title>
    <style type="text/css">
        .form-control
        {
            display: block;
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Button ID="btnUploadDoc" runat="server" Text="Upload" 
                            OnClick="btnUploadDoc_Click" CssClass="button" />
                    </td>
                </tr>
