<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MSSPDUpDraft.aspx.cs" Inherits="GGC.UI.Emp.MSSPDUpDraft" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Upload Name change Draft</title>
    <style type="text/css">
        .form-control
        {
            display: block;
    ...
    <div id="main">
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <li class="selected"><a href="MSSPDDraft.aspx">Home</a></li>
        ...
        <div class="mainbody">
            <center>
                <h3>
                    Upload 
                    proposal name change draft Document</h3>
            </center>
