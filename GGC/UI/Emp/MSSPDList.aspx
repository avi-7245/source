<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MSSPDList.aspx.cs" Inherits="GGC.UI.Emp.MSSPDList" %>
        ...
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <li class="selected" id="li1" runat="server"><a href="MSSPDDraft.aspx">Home</a></li>
