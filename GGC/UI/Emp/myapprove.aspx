<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="myapprove.aspx.cs" Inherits="GGC.UI.Emp.myapprove" %>
        ...
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <li class="selected" id="Li2" runat="server"><a href="ProposalApprovalList.aspx">Back</a></li>
