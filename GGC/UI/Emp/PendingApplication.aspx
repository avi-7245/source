<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PendingApplication.aspx.cs" Inherits="GGC.UI.Emp.PendingApplication" %>
...
<div id="main">
    ...
    <form id="form1" runat="server">
     <div class="mainbody">
            <center>
                <h3>
                    Developer Pending Application List.</h3>
            </center>
          <%--  <div>
        ...
        <tr>
            <td align="center">
                <asp:GridView ID="GVApplications" runat="server" AutoGenerateColumns="False" 
                    CellPadding="4" ForeColor="#333333" GridLines="Both" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="APP_STATUS_DT" HeaderText="Status Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center" />
