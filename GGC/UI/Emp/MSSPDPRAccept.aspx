<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MSSPDPRAccept.aspx.cs" Inherits="GGC.UI.Emp.MSSPDPRAccept" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Proposal Change in Name</title>
    <style type="text/css">
        .form-control
        {
            display: block;
    ...
    <div id="main">
        ...
        <div class="mainbody">
            ...
            <tr style="display:none">
                    ...
                    <td>
                        <asp:LinkButton ID="lnkGC" runat="server" onclick="lnkGC_Click">Download Created GC</asp:LinkButton>
