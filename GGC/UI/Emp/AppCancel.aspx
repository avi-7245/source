<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppCancel.aspx.cs" Inherits="GGC.UI.Emp.AppCancel" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Cancel the Application</title>
    <style type="text/css">
        .form-control
        {
            display: block;
        ...
        <div class="mainbody">
            ...
            <table width="100%" align="center" cellspacing="0">
                ...
                <tr id="Tr3" runat="server">
                    ...
                    <td>
                    <asp:FileUpload ID="FUCancel" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
