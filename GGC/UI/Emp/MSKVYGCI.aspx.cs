...
{
    public partial class MSKVYGCI : System.Web.UI.Page
    {
        ...
        protected void fillGrid()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd;
                    ...
                    strQuery = "select a.* ,date_format(a.APP_STATUS_DT,'%Y-%m-%d') APP_STATUS_DT from mskvy_applicantdetails_spd a,proposalapproval_spd b order by a.CREATED_DT desc";
