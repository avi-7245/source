...
{
    public partial class FeasibilityConsent : System.Web.UI.Page
    {
        protected static readonly ILog log = LogManager.GetLogger(typeof(Feasibility));
        ...
        void fillData()
        {
            ...
            try
            {
                ...
                {
                    strQuery = "select * from APPLICANTDETAILS where APPLICATION_NO='" + strAppID + "' and docLFS is not null and docLFSOther is not null ";
        ...
        protected void btnApproved_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                strQuery = "Update APPLICANTDETAILS set WF_STATUS_CD_C=13, app_status='PROPOSAL FEASIBILITY CONSENT VERIFIED.' ,APP_STATUS_DT=CURDATE() where APPLICATION_NO='" + strAppID + "'";
                cmd = new MySqlCommand(strQuery, mySqlConnection);
                cmd.ExecuteNonQuery();
                objSaveToMEDA.saveApp(Session["PROJID"].ToString(), "13");
        ...
        protected void btnReject_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                strQuery = "Update APPLICANTDETAILS set WF_STATUS_CD_C=12, app_status='Proposal feasibility consent rejected.' ,APP_STATUS_DT=CURDATE() where APPLICATION_NO='" + strAppID + "'";
                cmd = new MySqlCommand(strQuery, mySqlConnection);
                cmd.ExecuteNonQuery();

                objSaveToMEDA.saveApp(Session["PROJID"].ToString(), "12");
