...
{
    public partial class FinalGCDraftUpload : System.Web.UI.Page
    {
        ...
        protected void btnUploadDraftGC_Click(object sender, EventArgs e)
        {
            ...
            if (Session["IsValid"] != "false")
            {
                ...
                if (FUUploadDraftGC.HasFile)
                {
                    ...
                    try
                    {
                        ...
                        FUUploadDraftGC.SaveAs(folderPath + Path.GetFileName(FUUploadDraftGC.FileName));
                        newFileName = strAppID + "_" + "_1_" + DateTime.Now.ToString().Replace("/", "").Replace(" ", "").Replace(":", "").ToString() + "_" + FUUploadDraftGC.FileName;
                        System.IO.File.Move(folderPath + FUUploadDraftGC.FileName, folderPath + newFileName);
                        ...
                        switch (mySqlConnection.State)
                        {
                            ...
                            case System.Data.ConnectionState.Open:
                                string strQuery = "Update finalgcapproval set FGCDraftLetterFileName='" + newFileName + "' where APPLICATION_NO='" + strAppID + "'";
                                MySqlCommand cmd = new MySqlCommand(strQuery, mySqlConnection);
                                cmd.ExecuteNonQuery();
                                lblDraftMessage.Text = "Final Grid Connectivity draft letter Uploaded Successfully!!";
                                ...
                                strQuery = "insert into APPLICANT_STATUS_TRACKING " +
                                        " values('" + strAppID + "','Final Grid Connectivity draft propasal Uploaded.',now(),'" + Session["SAPID"].ToString() + "')";
                                cmd = new MySqlCommand(strQuery, mySqlConnection);
                                cmd.ExecuteNonQuery();
                    ...
                    catch (MySql.Data.MySqlClient.MySqlException mySqlException)
                    {
                        ...
                        log.Error(ErrorMessage);
                        lblDraftMessage.Text = "Letter Uploaded Failed!!";
                ...
                if (FUDoc.HasFile)
                {
                    ...
                    try
                    {
                        ...
                        switch (mySqlConnection.State)
                        {
                            ...
                            case System.Data.ConnectionState.Open:
                                string strQuery = "Update finalgcapproval set FGCDraftPrFileName='" + newFileName + "' where APPLICATION_NO='" + strAppID + "'";
                                MySqlCommand cmd = new MySqlCommand(strQuery, mySqlConnection);
                                cmd.ExecuteNonQuery();
                                lblResult.Text = "Final Grid Connectivity draft proposal Uploaded Successfully!!";
            ...
            try
            {
                ...
                switch (mySqlConnection.State)
                {
                    ...
                    case System.Data.ConnectionState.Open:
                        ...
                        string strQuery = "update finalgcapproval set WF_STATUS_CD= 26 , roleid=51, APP_STATUS='FGC Proposal send for approval.', APP_STATUS_DT=now() where APPLICATION_NO='" + strAppID + "'";
                        MySqlCommand cmd = new MySqlCommand(strQuery, mySqlConnection);
                        cmd.ExecuteNonQuery();
