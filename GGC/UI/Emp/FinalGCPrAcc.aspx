<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinalGCPrAcc.aspx.cs" Inherits="GGC.UI.Emp.FinalGCPrAcc" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Final GC Proposal Acceptance</title>
    <style type="text/css">
        .form-control {
            display: block;
            width: 85%;
            ...
            <div class="mainbody">
                ...
                <table width="100%" align="center" cellspacing="0">
                    ...
                    <tr style="display: none;">
                        <td>Interconnection Arrangement :
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblIsDeviation" runat="server" Text=""></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>Deviation Remark:
                        ...
                        <td>
                            <asp:Label ID="lblDevRemark" runat="server" Text=""></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>Remark :
                ...
                <tr id="Tr2" runat="server" visible="false">
                    ...
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Button ID="btnApproved" Text="Confirm" runat="server" CssClass="button"
                                OnClick="btnApproved_Click" />
                            &nbsp;&nbsp;
                        <asp:Button ID="btnReturn" Text="Return" runat="server" CssClass="button"
                            ValidationGroup="Reject" OnClick="btnReturn_Click" />&nbsp;&nbsp;
                            <asp:Button ID="btnViewPropsal" Text="Download FGC Propsal" runat="server" CssClass="button"
                                ValidationGroup="prop" OnClick="btnViewPropsal_Click" />&nbsp;&nbsp;
                            <asp:Button ID="btnViewLetter" Text="Download FGCLetter" runat="server" CssClass="button"
                                ValidationGroup="prop" OnClick="btnViewLetter_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center">
