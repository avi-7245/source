<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pendingproposals.aspx.cs" Inherits="GGC.UI.Emp.pendingproposals" %>
...
--%>                        <asp:BoundField DataField="CONT_PER_NAME_1" HeaderText="CONTACT PERSON" Visible="false" />
                        ...
                        <asp:TemplateField HeaderText="Approve/Return">
                            <ItemTemplate>
                                <asp:Button ID="btnApprRet" Text="Approve/Return" runat="server" CssClass="button"  CommandName="ApproveReturn" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        <%--<asp:TemplateField HeaderText="Approve/Return">
                            <ItemTemplate>
