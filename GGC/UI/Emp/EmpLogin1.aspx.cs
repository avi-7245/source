...
{
    public class SMSDTO1
    {
        public string a1 { get; set; }
        public string a2 { get; set; }
        public string a3 { get; set; }
    }
    public partial class EmpLogin1 : System.Web.UI.Page
    {
                    ...
                    switch (mySqlConnection.State)
                    {
                        ...
                        case System.Data.ConnectionState.Open:
                            ...
                            if (dsResult.Tables[0].Rows.Count > 0)
                            {
                                ...
                                Session["EmpRole"] = dsResult.Tables[0].Rows[0]["ROLE_ID"].ToString();
                                Session["SAPID"] = dsResult.Tables[0].Rows[0]["SAPID"].ToString();
                                Session["ReportingSAPID"] = dsResult.Tables[0].Rows[0]["ReportingOfficerSAPID"].ToString();
                                Session["EmpZone"] = dsResult.Tables[0].Rows[0]["ZONE"].ToString();
                                Session["EmpDesignation"] = dsResult.Tables[0].Rows[0]["Designation"].ToString();
                                Session["EmpName"] = dsResult.Tables[0].Rows[0]["Emp_Name"].ToString();
                                Session["ekycid"] = dsResult.Tables[0].Rows[0]["ekycid"].ToString();
