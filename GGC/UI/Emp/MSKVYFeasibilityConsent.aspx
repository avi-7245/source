<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MSKVYFeasibilityConsent.aspx.cs" Inherits="GGC.UI.Emp.MSKVYFeasibilityConsent" %>
...
<body>
    <div id="main">
        ...
        <div class="mainbody">
            <center>
                <h3>
                    Grid Connectivity Proposal Consent</h3>
            </center>
            <table width="100%" align="center" cellspacing="0">
                ...
                <tr>
                <td colspan="2">
                                        <asp:Button ID="btnApproved" Text="Verify" runat="server" ValidationGroup="Reject"  
                            CssClass="button" onclick="btnApproved_Click" />
                            <asp:Button ID="btnReject" Text="Return" runat="server" 
                            CssClass="button" ValidationGroup="Reject" onclick="btnReject_Click" />
