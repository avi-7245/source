<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GCIssued.aspx.cs" Inherits="GGC.UI.Emp.GCIssued" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>GC Issued</title>
    <style type="text/css">
        ...
        <tr>
            ...
            <asp:GridView ID="GVApplications" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Download GC" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                        <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Bind("IssueLetter") %>' />

                            <asp:Button ID="btnDownloadGC" Text="Download GC" runat="server" CssClass="button"
                                CommandName="DownloadGC" CommandArgument="<%# Container.DataItemIndex %>" />
                        </ItemTemplate>
                    </asp:TemplateField>
