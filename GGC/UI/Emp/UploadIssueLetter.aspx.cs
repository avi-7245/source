...
{
    public partial class UploadIssueLetter : System.Web.UI.Page
    {
                    ...
                    try
                    {
                        ...
                        switch (mySqlConnection.State)
                        {
                            ...
                            case System.Data.ConnectionState.Open:
                                string strQuery = "Update APPLICANTDETAILS set WF_STATUS_CD_C=19, IssueLetter='" + newFileName + "' , IssueLetterDt=CURDATE() , app_status='GRID CONNECTIVITY LETTER ISSUED.' where APPLICATION_NO='" + strAppID + "'";
                                ...
                                objSaveToMEDA.saveApp(Session["PROJID"].ToString(), "19");
