<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoadFlowStudy.aspx.cs" Inherits="GGC.UI.Emp.LoadFlowStudy" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
 <title>Load flow study</title>
      <style type="text/css">
        .form-control
        {
            display: block;
        ...
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <%--<li class="selected"><a href="PendingApplication.aspx">Pending Application</a></li>
            ...
            <td>--%>
                ...
                onrowdatabound="GVApplications_RowDataBound">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="APP_STATUS_DT" HeaderText="Status Date" DataFormatString="{0:dd-MMM-yyyy}"  ItemStyle-Width="70px"/>
                        <asp:TemplateField HeaderText="View All Documents" ItemStyle-HorizontalAlign="Center"> 
                            <ItemTemplate>
                                <asp:Button ID="btnViewAllDoc" Text="View" runat="server" CssClass="button"  CommandName="ViewAllDoc" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Upload LFS" ItemStyle-HorizontalAlign="Center"> 
                            <ItemTemplate>
                                <asp:Button ID="btnView" Text="Upload" runat="server" CssClass="button" Enabled="false" CommandName="UploadLFS" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="GC Proposal Feasibility (STU)" ItemStyle-HorizontalAlign="Center"> 
                            <ItemTemplate>
                                <asp:Button ID="btnFeasibility" Text="Confirm" runat="server" CssClass="button" Enabled="false" CommandName="Feasibility" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="GC Proposal Recommendation/ Approval" ItemStyle-HorizontalAlign="Center"> 
                            <ItemTemplate>
                                <asp:Button ID="btnFeasibilityConsent" Text="Confirm" runat="server" CssClass="button" Enabled="false" CommandName="FeasibilityConsent" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <%--<asp:TemplateField HeaderText="Send Proposal">
                            <ItemTemplate>
                                <asp:Button ID="btnSendProposal" Text="Send Proposal" runat="server" CssClass="button"  CommandName="SendProposal" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        <%--<asp:TemplateField HeaderText="Technical Feasibility">
                            <ItemTemplate>
                                <asp:Button ID="btnUpload" Text="Upload" runat="server" CssClass="button"  CommandName="Upload" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="View Feasibility">
                            <ItemTemplate>
                                <asp:Button ID="btnViewTech" Text="View" runat="server" CssClass="button"  CommandName="ViewTech" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>
