...
{
    public partial class MSKVYPropApprovalList : System.Web.UI.Page
    {
        protected static readonly ILog log = LogManager.GetLogger(typeof(MSKVYPropApprovalList));
            ...
            try
            {
                ...
                switch (mySqlConnection.State)
                {
                    ...
                    case System.Data.ConnectionState.Open:
                        ...
                        //                        strQuery = "SELECT a.*,b.* FROM MSKVY_applicantdetails  a, proposalapproval b  WHERE a.APPLICATION_NO=b.APPLICATION_NO and b.roleid='" + Session["EmpRole"].ToString() + "' ";
                        strQuery = "SELECT distinct a.APPLICATION_NO, a.MEDAProjectID ,a.PROMOTOR_NAME,a.PROJECT_LOC,a.NATURE_OF_APP,a.PROJECT_TYPE,a.PROJECT_CAPACITY_MW,a.app_status,a.APP_STATUS_DT,concat(a.PROJECT_LOC,' ', a.PROJECT_TALUKA,' ', a.PROJECT_DISTRICT) as Location,Quantum_power_injected_MW FROM MSKVY_applicantdetails  a, proposalapproval b  WHERE a.APPLICATION_NO=b.APPLICATION_NO and b.roleid='" + Session["EmpRole"].ToString() + "' and WF_STATUS_CD_C<15";
        ...
        protected void GVApplications_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "ApproveReturn")
            {
                ...
                Response.Redirect("~/UI/Emp/MSKVYPropasalAcceptance.aspx?application=" + applicationId, false);
            }
            if (e.CommandName == "ViewLFS")
            {
                ...
                applicationId = row.Cells[0].Text;
                ...
                //DataSet dsResult = SQLHelper.ExecuteDataset(conString, CommandType.Text, "select * from MSKVY_applicantdetails where Application_no='" + applicationId + "'");
                //Response.ContentType = "application/pdf";
                //Response.AppendHeader("Content-Disposition", "attachment; filename=MSKVY_GC_LFS" + applicationId + ".pdf");
                //Response.TransmitFile(folderPath + dsResult.Tables[0].Rows[0]["docLFS"].ToString());
                //Response.End();
            }
