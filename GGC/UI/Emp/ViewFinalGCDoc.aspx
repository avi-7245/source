<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewFinalGCDoc.aspx.cs" Inherits="GGC.UI.Emp.ViewFinalGCDoc" %>
...
<body>
        ...
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <%--<li class="selected"><a href="FinalGCDoc.aspx">Back</a></li>--%>
                </ul>
            </div>
        </div>
    ...
    <div style="text-align:right;width:85%" align="center">
        <asp:LinkButton ID="lnkBack" runat="server" CssClass="selected" 
            onclick="lnkBack_Click" Font-Bold="True" Font-Size="Large" >Back</asp:LinkButton></div>
    <div class="mainbody">
            <center>
                <h3>
