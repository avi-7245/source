<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewScheduler.aspx.cs" Inherits="GGC.UI.Emp.ViewScheduler" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>View Scheduler</title>
        <style type="text/css">
    ...
    <div id="main">
        ...
        <div id="menubar">
                <ul id="menu">
                    ...
                    <li class="selected" id="liHome" runat="server"><a href="EmpHome.aspx">Home</a></li>
                    <li class="selected" id="liSignOut" runat="server"><a href="EmpLogin.aspx">SignOut</a></li>
                    <%--<li class="selected" id="liSignOut" runat="server" >
                        <asp:LinkButton ID="lnkSignOut" runat="server" OnClick="lnkSignOut_Click">SignOut</asp:LinkButton></li>--%>
                </ul>
