<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAllMSKDoc.aspx.cs" Inherits="GGC.UI.Emp.ViewAllMSKDoc" %>
        ...
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <%--NeedToCheck--%>
                    <li class="selected" id="lnkAdmin" runat="server"><a href="MSKVYHome.aspx">Home</a></li>
                    <%--<li class="selected" id="lnkEE" runat="server"><a href="MSKVYHome.aspx">Home</a></li>--%>
