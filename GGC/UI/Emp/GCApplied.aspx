<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GCApplied.aspx.cs" Inherits="GGC.UI.Emp.GCApplied" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>GC Applied</title>
        ...
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <li class="selected" id="mgtHome" runat="server"><a href="ProposalApprovalList.aspx">Home</a></li>
            ...
            <td>--%>
                <asp:GridView ID="GVApplications" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                       ...
                       <asp:BoundField DataField="PROMOTOR_NAME" HeaderText="ORGANIZATION NAME" >
                        ...
                        <asp:TemplateField HeaderText="View Documents" ItemStyle-HorizontalAlign="Center"> 
                            <ItemTemplate>
                                <asp:Button ID="btnViewAppZone" Text="Select" runat="server" CssClass="button"  CommandName="Select" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>
