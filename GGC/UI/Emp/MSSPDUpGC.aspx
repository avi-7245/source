<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MSSPDUpGC.aspx.cs" Inherits="GGC.UI.Emp.MSSPDUpGC" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>Upload Name change GC</title>
    <style type="text/css">
        .form-control
        {
            display: block;
...
<div id="main">
        ...
        <div class="mainbody">
            <center>
                <h3>
                    Upload proposal name change & GC document</h3>
            </center>
