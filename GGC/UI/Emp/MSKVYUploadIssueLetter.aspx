<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MSKVYUploadIssueLetter.aspx.cs" Inherits="GGC.UI.Emp.MSKVYUploadIssueLetter" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Upload Issue Letter</title>
    <style type="text/css">
        .form-control
        {
            display: block;
...
<body>
    <div id="main">
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <li class="selected"><a href="MSKVYCommList.aspx">Back</a></li>
        ...
        <div class="mainbody">
            <center>
                <h3>
                    Upload MSKVY Grid Connectivity Issue Letter.</h3>
            </center>
            <table width="100%" align="center" cellspacing="5">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnUploadDoc" Text="Upload" runat="server" 
                            ValidationGroup="UploadIL" onclick="btnUploadDoc_Click"  />
                    </td>
                    <td>
