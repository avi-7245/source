<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppReturn.aspx.cs" Inherits="GGC.UI.Emp.AppReturn" %>
...
<body>
    <div id="main">
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <li class="selected" runat="server" id="MSKVY"><a href="MSKVYHome.aspx">MSKVY</a></li>
                    <li class="selected" runat="server" id="MSSPD"><a href="MSSPDDraft.aspx">MS-SPD</a></li>
        ...
        <div class="mainbody">
            ...
            <tr>
            <td>
            <font color="red">*</font>Reason for returning:
            </td>
            <td>
                <asp:TextBox ID="txtReturn" runat="server" TextMode="MultiLine"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator119" runat="server" ForeColor="Red"
                            Display="Dynamic" ErrorMessage="*Required" ControlToValidate="txtReturn" ValidationGroup="return"
                ...
                <asp:Button ID="btnReturn" Text="Return" runat="server" ValidationGroup="return"
