<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MSKVYPropApprovalList.aspx.cs" Inherits="GGC.UI.Emp.MSKVYPropApprovalList" %>
        ...
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <li class="selected" id="Li1" runat="server"><a href="ViewAllMSKDoc.aspx">View All Applications</a></li>
                    <li class="selected" id="AppGC" runat="server"><a href="ProposalApprovalList.aspx">Home</a></li>
...
--%>                
                        ...
                        <asp:BoundField DataField="Quantum_power_injected_MW" HeaderText="PROJECT CAPACITY(MW)" >
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        </asp:BoundField>
                    ...
                    --%>    <asp:BoundField DataField="APP_STATUS_DT" HeaderText="Status Date" DataFormatString="{0:dd-MMM-yyyy}" />
                        ...
                        <asp:TemplateField HeaderText="View Documents" >
                            <ItemTemplate>
                                <asp:Button ID="btnView" Text="View" runat="server" CssClass="button"  CommandName="ViewLFS" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>
