<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FGCPRAccept.aspx.cs" Inherits="GGC.UI.Emp.FGCPRAccept" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Proposal FGC</title>
    <style type="text/css">
        .form-control
        {
            display: block;
...
<body>
    <div id="main">
        ...
        <div class="mainbody">
            <center>
                <h3>
                    Proposal for Final Grid Connectivity .</h3>
            </center>
            <table width="100%" align="center" cellspacing="0">
                ...
                <td>
                     <asp:Label ID="lblIsDev" runat="server" Text=""></asp:Label>
                </td>
                </tr>
                <tr>
                <td>
