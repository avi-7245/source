<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FGCHome.aspx.cs" Inherits="GGC.UI.Emp.FGCHome" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>FGC Home</title>
    <style type="text/css">
        ...
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <li class="selected" id="Home" runat="server"><a href="EmpHome.aspx">View Documents</a></li>
            ...
            <td>--%>
                <asp:GridView ID="GVApplications" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <%-- <asp:TemplateField HeaderText="Confirm/Return FGC" ItemStyle-HorizontalAlign="Center"> 
                            <ItemTemplate>
                                <asp:Button ID="btnFeasibility" Text="Select" runat="server" CssClass="button"  CommandName="AppFGC" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>--%>

                        <asp:TemplateField HeaderText="Any Deviation required" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Button ID="btnIsDev" Text="Yes/No" runat="server" CssClass="button" CommandName="isDev" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="View FGC" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Button ID="btnFeasibility" Text="Select" runat="server" CssClass="button" CommandName="UploadDraft" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Approve/Return Proposal" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Button ID="btnUploadGC" Text="Select" runat="server" CssClass="button" CommandName="AppFGC" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
