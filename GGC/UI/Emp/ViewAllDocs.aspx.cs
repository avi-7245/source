...
{
    public partial class ViewAllDocs : System.Web.UI.Page
    {
        protected static readonly ILog log = LogManager.GetLogger(typeof(ViewAllDocs));
                    ...
                    case System.Data.ConnectionState.Open:
                        ...
                        switch(doctype)
                        {
                            case 1:
                                ...
                                break;
                            case 2:
                                strQuery = "select SLDDocName  as docname , WF_STATUS_CD_C from applicantdetails where APPLICATION_NO='" + applicationId + "'";
                                strFolderName = "SLD";
                                break;
                            case 3:
