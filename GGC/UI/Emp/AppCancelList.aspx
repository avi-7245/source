<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppCancelList.aspx.cs" Inherits="GGC.UI.Emp.AppCancelList" %>
            ...
            <td>
                <asp:GridView ID="GVApplications" runat="server" AutoGenerateColumns="False" 
                    ...
                    --%>    <asp:BoundField DataField="APP_STATUS_DT" HeaderText="Status Date" DataFormatString="{0:dd-MMM-yyyy}" />
                        ...
                        <asp:TemplateField HeaderText="Application cancel" Visible="false" >
                            <ItemTemplate>
                                <asp:Button ID="btnCancel" Text="Cancel" runat="server" CssClass="button"  CommandName="CancelApp" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>
