<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Feasibility.aspx.cs" Inherits="GGC.UI.Emp.Feasibility" %>
    ...
    <div id="main">
        ...
        <div class="mainbody">
            ...
            <table width="100%" align="center" cellspacing="0">
                ...
                <tr>
                <td colspan="2">
                                        <asp:Button ID="btnApproved" Text="Verified" runat="server"  ValidationGroup="Reject" 
                            CssClass="button" onclick="btnApproved_Click"/>
                            <asp:Button ID="btnReturn" Text="Return" runat="server" 
                            CssClass="button" onclick="btnReject_Click" ValidationGroup="Reject"/>
