...
{
    public partial class pendingproposals : System.Web.UI.Page
    {
        protected static readonly ILog log = LogManager.GetLogger(typeof(pendingproposals));
            ...
            try
            {
                ...
                switch (mySqlConnection.State)
                {
                    ...
                    case System.Data.ConnectionState.Open:
                        ...
                        strQuery = "SELECT a.*,b.* FROM applicantdetails a, proposalapproval b  WHERE a.APPLICATION_NO=b.APPLICATION_NO ";
