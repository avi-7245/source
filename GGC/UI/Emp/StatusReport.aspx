<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatusReport.aspx.cs" Inherits="GGC.UI.Emp.StatusReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Status report of registratio payment done</title>
     <style type="text/css">
        .form-control
        {
            display: block;
        ...
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <li class="selected" id="back" runat="server"><a href="EmpHome.aspx">Back</a></li>
        ...
        <tr>
            ...
            <div> 
                <asp:Button ID="btnExport" runat="server" Text="Export To Excel" CssClass="button"
                    onclick="btnExport_Click" /></div><br />
                ...
                onrowcommand="GVApplications_RowCommand">
                    ...
                    <Columns>
                    <asp:TemplateField HeaderText="Download activity report" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Button ID="btnDownload" Text="Download" runat="server" CssClass="button" CommandName="DownloadActivity"
...
--%>                     
                       <%--<asp:BoundField DataField="FRESH_OLD" HeaderText="FRESH OLD"/>--%>
                        ...
                        <asp:BoundField DataField="CREATED_DT" HeaderText="APPLICATION DATE" >
                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                        </asp:BoundField>
                        <asp:BoundField DataField="TxnDate" HeaderText="PAYMENT DATE" />
                        <asp:BoundField DataField="app_status" HeaderText="STATUS" />
                        <asp:BoundField DataField="APP_STATUS_DT" HeaderText="STATUS DATE" />
                        <asp:BoundField DataField="IssueLetterDt" HeaderText="LETTER ISSUE DATE" />
