<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadIssueLetter.aspx.cs" Inherits="GGC.UI.Emp.UploadIssueLetter" %>
...
<body>
    <div id="main">
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <li class="selected"><a href="CommFeeList.aspx">Back</a></li>
        ...
        <div class="mainbody">
            <center>
                <h3>
                    Upload Grid Connectivity Issue Letter.</h3>
            </center>
