<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MSKVYPropasalAcceptance.aspx.cs" Inherits="GGC.UI.Emp.MSKVYPropasalAcceptance" %>
            ...
            <div class="mainbody">
                ...
                <table width="100%" align="center" cellspacing="0">
                    <tr style="display: none;">
                        <td>
                            <asp:LinkButton ID="lnkAppForm" runat="server" OnClick="lnkAppForm_Click">Download Application Form</asp:LinkButton>

                        </td>
                        <td>
                            <asp:LinkButton ID="lnkGC" runat="server" OnClick="lnkGC_Click">Download Deemed GC</asp:LinkButton>
