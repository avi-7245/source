 ...
 <div style="background-color:#5D7B9D">
    ...
    <b><font size="+3" style="color: white;">Maharashtra State Electricity Transmission Company
        LTD.</font></b>
            ...
            <br />
            <%--<center>
        <font size="+1" style="color: Blue;padding-top:20px;">Grid Connectivity Dashboard</font></center>--%>
        <div id="menubar">
        <ul id="menu">
                   
                    <li class="selected" id="mgtHome" runat="server"><a href="ProposalApprovalList.aspx">
                        Proposal List</a></li>
                        <li class="selected" id="empHome" runat="server"><a href="EmpHome.aspx">
                        Home</a></li>
                         <li class="selected" id="Li1" runat="server"><a href="Monthwisereport.aspx">
                        Monthwise</a></li>
