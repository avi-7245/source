...
{
    public partial class FinalGCPrList : System.Web.UI.Page
    {
        protected static readonly ILog log = LogManager.GetLogger(typeof(FinalGCPrList));
        ...
        protected void GVApplications_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Select")
            {
                ...
                Session["APPID"] = row.Cells[0].Text;
                Session["MEDAID"] = row.Cells[1].Text;
                Response.Redirect("~/UI/Emp/FinalGCPrAcc.aspx?application=" + applicationId, false);
            }
        }
    }
}