<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Monthwisereport.aspx.cs"
    Inherits="GGC.UI.Emp.Monthwisereport" %>
...
<body>
    <div style="background-color: #5D7B9D">
        ...
        <b><font size="+3" style="color: white;">Maharashtra State Electricity Transmission
            Company LTD.</font></b>
    </div>
    <br />
    <div id="menubar">
    ...
    <div class="mainbody">
        <center>
            <h3>
                Monthwise Dashboard</h3>
        </center>
        <table width="50%" align="right" cellspacing="5" border="1" style="border-color: Black;">
            <tr>
                ...
                <td align="left" width="45%">
                    <asp:Button ID="btnSubmit" runat="server" CssClass="simplebutton2" Text="Submit"
                        OnClick="btnSubmit_Click" />
                </td>
            </tr>
        </table>
        <table width="90%" align="center" cellspacing="5" style="border: none">
            <tr>
                <td align="center">
                    <%--<asp:Chart ID="Chart1" runat="server" Height="435px" Width="600px" BackColor="Honeydew"
                            BorderlineWidth="1" Palette="None" PaletteCustomColors="Maroon"  BorderlineColor="64, 0, 64">
                            <Series>
                    ...
                    <asp:Chart ID="Chart1" runat="server" Height="435px" Width="600px" BackColor="Honeydew"
                        ...
                        <Series>
                            <asp:Series Name="stages" XValueMember="stages" YValueMembers="Total">
                                </asp:Series>
                        </Series>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1" BackColor="White" />
                ...
                <td align="center">
                    ...
                    <asp:Chart ID="Chart2" runat="server" Height="435px" Width="600px" BackColor="Honeydew"
                        BorderlineWidth="0" Palette="None" PaletteCustomColors="Maroon" BorderlineColor="64, 0, 64">
                        <Series>
                            <asp:Series Name="Series1" XValueMember="stages" YValueMembers="Total">
                            </asp:Series>
                        </Series>
                        <Legends>
                        ...
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1" BackColor="White" Area3DStyle-LightStyle="Realistic">
                                <Area3DStyle Enable3D="True" />
                            </asp:ChartArea>
                        </ChartAreas>
                    </asp:Chart>
