<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewapp.aspx.cs" Inherits="GGC.UI.Emp.viewapp" %>
...
<div id="main">
    ...
    <div class="mainbody">
         ...
         <div>
        <table align="center" id="tbApprRet" runat="server" visible="true">
            <tr>
                <td>
                Comments If any : 
                </td>
                <td>
                    <asp:TextBox ID="txtComments" runat="server" MaxLength="60"></asp:TextBox>
