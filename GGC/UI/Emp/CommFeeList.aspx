<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommFeeList.aspx.cs" Inherits="GGC.UI.Emp.CommFeeList" %>
...
<body>
        ...
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <li class="selected"><a href="MSKVYCommList.aspx">MSKVY Committment Fees</a></li>
    ...
    <form id="form1" runat="server">
     <div class="mainbody">
            <center>
                <h3>
                    Issue Demand Note / GC Letter List.</h3>
            </center>
          <%--  <div>
...
--%>                        
                        ...
                        <asp:TemplateField HeaderText="Upload PPA" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>

                                <asp:Button ID="btnUploadPPA" Text="Upload" runat="server" CssClass="button"  CommandName="UploadPPA" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Issue Demand Note" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
