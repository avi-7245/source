            ...
            try
            {
                ...
                switch (mySqlConnection.State)
                {
                    ...
                    case System.Data.ConnectionState.Open:
                        ...
                        {
                            cmd = new MySqlCommand("select *  from MSKVY_applicantdetails_spd  where USER_NAME='" + strUserID + "'", mySqlConnection);
                            ...
                            if (dsResult2.Tables[0].Rows.Count > 0)
                            {
                                ...
                                Session["PROMOTOR_NAME"] = dsResult2.Tables[0].Rows[0]["NAME_OF_SPD"].ToString();
                        ...
                        else
                        {
                            ...
                            try
                            {
                                ...
                                strQuery = "insert into MSKVY_SPV_DET" +
                                    " values('" + uReg.generatorId + "','" + uReg.generatorName + "','" + uReg.generatorPan + "','" + uReg.generatorId + "','" + uReg.generatorName + "')";
                                cmd = new MySqlCommand(strQuery, mySqlConnection);
                                cmd.ExecuteNonQuery();
