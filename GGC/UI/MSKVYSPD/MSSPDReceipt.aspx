<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MSSPDReceipt.aspx.cs" Inherits="GGC.UI.MSKVYSPD.MSSPDReceipt" %>
    ...
    <div class="mainbody">
        ...
        <table width="50%" cellspacing="5" align="center">
                ...
                <td colspan="2" align="center">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/UI/MSKVYSPD/AppHome.aspx">Click here for Home</asp:HyperLink>
                </td>
                </tr>
            </table>
            </center>
