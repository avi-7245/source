<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewDoc.aspx.cs" Inherits="GGC.UI.MSKVYSPD.ViewDoc" %>
...
<body>
    ...
    <tr>
    <td>
        <asp:Button ID="btnViewDocNext" runat="server" Text="Next" CssClass="button" onclick="btnViewDocNext_Click" 
            />
    </td>
    <td>
