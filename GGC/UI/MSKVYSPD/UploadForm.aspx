<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadForm.aspx.cs" Inherits="GGC.UI.MSKVYSPD.UploadForm" %>
...
<body>
    ...
    <div class="mainbody">
            <center>
                <h3>
                   Upload Application Form</h3>
            </center>
     <table width="100%" align="center" align="center">
                <tr style="color: #333333;background-color: #F7F6F3;">
                    <td colspan="4">
                        <b>Upload Application Form with Seal & Signature</b>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:FileUpload ID="FUAppForm" runat="server" onchange="checkUploadFile(this);" />
                        <asp:Label ID="lblLetterUploadStatus" runat="server" Text=""></asp:Label>
                    </td>
                    <td>
                        <asp:Button ID="btnUploadApp" Text="Upload" runat="server" ValidationGroup="Photo"
                            CssClass="button" onclick="UploadAppForm" />
                    </td>
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="FUAppForm"
